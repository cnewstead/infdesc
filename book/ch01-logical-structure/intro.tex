...
%The effectiveness of a good mathematical proof is influenced by many factors:
%\begin{itemize}
%\item \textbf{Correctness.} Are the steps in the proof logically valid? Are the assumptions made and conclusions drawn appropriate? Are definitions and results applied accurately?
%\item \textbf{Completeness.} Is the conclusion reached? Are any claims made without sufficient justification?
%\item \textbf{Clarity.} Is the proof understandable to a member of its target audience? Is the logical flow of the proof made clear to the reader? Is sufficient detail provided, and if so, do the details obfuscate the bigger picture?
%\end{itemize}
%
%It is difficult to think about all of these things at the same time, especially if the result you are trying to prove is very complicated---in fact, sometimes it is difficult just to get started, or to know what to write in order to communicate your ideas.
