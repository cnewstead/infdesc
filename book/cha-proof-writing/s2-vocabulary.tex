...
\begin{extract}[\xtrsource{thmCauchySchwarzInequality}]
...
Let $(x_n)$ be a sequence of real numbers and \xtremph{et $a,b \in \mathbb{R}$ be such that} $a < x_n < b$ for each $n \ge 0$---the numbers \xtremph{$a$ and $b$ exist since} the sequence $(x_n)$ is bounded.
\end{extract}
