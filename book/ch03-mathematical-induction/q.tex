...
\todo{Move to the number theory chapter; this is easier without induction!}
Let $n \in \mathbb{N}$. Use induction to prove that the number of trailing $0$s in the decimal expansion of $n!$ is equal to
