...
Note that, by contraposition, condition (b) in \Cref{exConditionsForPartition} is equivalent to saying that the subsets in $\mathcal{U}$ are \textit{pairwise disjoint}---that is, given $i,j \in I$, if $i \ne j$, then $U_i \cap U_j$ is empty.
